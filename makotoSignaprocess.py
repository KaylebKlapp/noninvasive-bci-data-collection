...
def preprocess_Makoto(arr, high_pass_cutoff=1.0, sampling_rate=100.0):
    ...
    b, a = signal.butter(N=4, Wn=high, btype='high', analog=False, output='ba')
...
print(double_array)
finalaray1 = preprocess_Makoto(double_array)
print(finalaray1)
